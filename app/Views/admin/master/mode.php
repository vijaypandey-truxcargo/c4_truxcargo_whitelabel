...
<div id="page-wrapper">
    <div class="col-md-12 graphs">
        ...
        <div style="margin-bottom:15px; width:100%; display:flex; justify-content:space-between; align-items:center;">
            ...
            <!-- LEFT: TITLE -->
            <h3 style="margin:0;">All Mode</h3>

            <!-- RIGHT SIDE BUTTONS -->
            <div style="display:flex; align-items:center; gap:10px;">

                <?php if (in_array("Add Mode", $GLOBALS['permission'])): ?>
                    <?= anchor('admin/mode/add_mode', 'New Mode', [
                        'class' => 'btn btn-danger'
                    ]); ?>
                <?php endif; ?>
                <?php if (in_array("Import Mode", $GLOBALS['permission'])): ?>
                    <button id="exportSampleBtn" type="button" class="btn btn-success">
                            Download Sample
                        </button>
                    <?= form_open_multipart('admin/mode/import_mode', [
                    ...
                    <?php endif; ?>
                     <?php if (in_array("Export Mode", $GLOBALS['permission'])): ?>
                    ...
                    <tbody>
                        ...
                        foreach ($code as $key): $count++; ?>
                            <tr class="active">
                                ...
                                <td width="18%">
                                    <?php if (in_array("Edit Mode", $GLOBALS['permission'])): ?>
                                        <?= anchor("admin/mode/edit_mode/{$key->id}", 'Edit', [
