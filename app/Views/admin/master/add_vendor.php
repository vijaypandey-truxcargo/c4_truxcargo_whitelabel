    ...
    <div class="col-md-12 graphs">
        <div class="xs">
            ...
            <div class="well1 white">
                <?= form_open_multipart('admin/vendor/insert_vendor', ['class' => 'form-floating']); ?>
                <fieldset>
                    <div class="row">
                        <!-- Left Column -->
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="air_divisor" class="form-control"  placeholder="Enter 4-digit divisor">
                            </div>

                               <!-- SFC Divisor -->
                            <div class="form-group">
                                <label class="control-label">SFC Divisor</label>
                                <input type="number" name="sfc_divisor" class="form-control"  placeholder="Enter 4-digit divisor">
                            </div>
                            
                                <!-- Freight -->
                            <div class="form-group">
                                <label class="control-label">Min Freight</label>
                                <input type="number" name="min_freight" class="form-control" step="any" placeholder="Enter Min Freight">
                            </div>
                                ...
                                <select name="mode" class="form-control" required="">
                                    ...
                                    <?php
                                        foreach($mode as $mode_name){ ?>
                                            <option value="<?php echo $mode_name->id ?>"><?php echo $mode_name->name ?></option>
                                    <?php }
                                    ?>
                                </select>
                            </div> -->
                        ...
                        <!-- Type -->
                            <div class="form-group">
                                ...
                                <select name="vendor_type" class="form-control" required ="">
                                    ...
                                    <option value="INVENTORY VENDOR">   </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="destination_hub" id="hub_id" required ="">
                                    <option value="">SELECT HUB</option>
                                    <?php
                                        foreach($hub as $hubname){ ?>
                                            <option value="<?php echo $hubname->id ?>"><?php echo $hubname->code ?></option>
                                    <?php }
                                    ?>
                                </select>
                            </div>
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" name="min_weight" placeholder="Enter Min Weight" class="form-control" required>
                            </div>

                            <!-- Max Actual -->
                           <div class="form-group">
                                <label>Max Actual Weight <span class="text-danger">*</span></label>
                                <input type="text" name="max_weight"  placeholder="Enter Max Weight" class="form-control" required>
                            </div>
