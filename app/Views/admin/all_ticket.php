        ...
        <div class="xs">
            ...
            <div class="support-panel">
                <ul class="nav nav-tabs support-tabs">
                    <li class="active"><a href="<?= base_url('admin/support/ticket'); ?>"><i class="fa fa-inbox"></i> Open</a></li>
                ...
                <div class="support-toolbar">
                    <div><span class="status-pill status-open">Open</span></div>
                ...
                <div class="table-responsive">
                    <table class="table support-table" id="example">
                        ...
                        <tbody>
                            <?php if (! empty($open)): ?>
                                <?php foreach ($open as $row): ?>
                                    <tr>
                                        ...
                                        <td><div class="text-truncate-soft" title="<?= esc($row->detail ?? ''); ?>"><?= esc($row->detail ?? ''); ?></div></td>
                                        <td>
                                            <div class="support-actions">
                                                <a class="btn btn-primary btn-sm btn-icon" href="<?= base_url("admin/support/reply_ticket/{$row->id}"); ?>" title="Reply">
                                                    <i class="fa fa-pencil-square-o"></i> Reply
                                                </a>
                                                <?php if (in_array('Add Support', $GLOBALS['permission'])): ?>
                                                    <button class="btn btn-success btn-sm btn-icon" onclick="reply(<?= $row->id; ?>)" data-toggle="modal" data-target="#reply" title="Update status">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="9" class="empty-state"><i class="fa fa-inbox"></i>No open ticket found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
        ...
        <div class="content-area-footer" id="footer">
            <div class="row">
                <div class="col-lg-6 text-left">
                    <label class="checked">
                        <i class="fa fa-minus-square-o red" style="font-size: 18px" onClick="minus(this)"></i>
                    </label>
