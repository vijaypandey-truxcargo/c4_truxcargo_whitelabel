    ...
    <div class="col-md-12 graphs">
        <div class="xs">
            <div class="support-header">
                <h3 class="support-title"><i class="fa fa-folder-open"></i> Support Issue Category</h3>
                <?php if (in_array('Add Support', $GLOBALS['permission'])): ?>
                    <?= anchor('admin/support/add_category', '<i class="fa fa-plus"></i> Add Issue Category', ['class' => 'btn btn-danger btn-icon']); ?>
                <?php endif; ?>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table support-table">
                        ...
                        <tbody>
                                        ...
                                        <td>
                                            <?php if (in_array('Add Support', $GLOBALS['permission'])): ?>
                                                <div class="support-actions">
                                                    <?= anchor("admin/support/edit_category/{$row->id}", '<i class="fa fa-pencil"></i> Edit', ['class' => 'btn btn-primary btn-sm btn-icon']); ?>
                                                    <?= form_open('admin/support/delete_category', ['onsubmit' => 'return validate(this);']); ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="3" class="empty-state"><i class="fa fa-folder-open-o"></i>No category found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
