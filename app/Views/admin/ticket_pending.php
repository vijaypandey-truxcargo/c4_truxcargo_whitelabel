        ...
        <div class="xs">
            ...
            <div class="support-panel">
                <ul class="nav nav-tabs support-tabs">
                    ...
                    <li class="active"><a href="<?= base_url('admin/support/pending'); ?>"><i class="fa fa-clock-o"></i> Pending</a></li>
                ...
                <div class="support-toolbar">
                    <div><span class="status-pill status-pending">Pending</span></div>
                ...
                <div class="table-responsive">
                    <table class="table support-table" id="example">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="empty-state"><i class="fa fa-clock-o"></i>No pending ticket found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
